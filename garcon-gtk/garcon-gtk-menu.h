...
#if !defined(_GARCON_INSIDE_GARCON_GTK_H) && !defined(GARCON_GTK_COMPILATION)
...
GType
garcon_gtk_menu_get_type (void) G_GNUC_CONST;

GtkWidget *
garcon_gtk_menu_new (GarconMenu *garcon_menu) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
