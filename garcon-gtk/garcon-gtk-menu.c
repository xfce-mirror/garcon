...
garcon_gtk_menu_load_icon_from_theme (GtkIconTheme *icon_theme,
                                      ...
                                      gint          scale_factor)
{
  GdkPixbuf *pixbuf = gtk_icon_theme_load_icon_for_scale (icon_theme, icon_name, size, scale_factor, 0, NULL);
  if (pixbuf == NULL)
    {
      pixbuf = gtk_icon_theme_load_icon (icon_theme, icon_name, size * scale_factor, 0, NULL);
    }
