...
#ifndef __G_DESKTOP_MENU_ENVIRONMENT_H__
#define __G_DESKTOP_MENU_ENVIRONMENT_H__

#include <glib.h>

G_BEGIN_DECLS

void         g_desktop_menu_set_environment (const gchar *env);
const gchar *g_desktop_menu_get_environment (void);

G_END_DECLS

#endif /* !__G_DESKTOP_MENU_ENVIRONMENT_H__ */
